...
export default function Connections() {
  ...
  const [settings, setSettings] = useState({
    ...
    facebookAutomationEnabled: false,
  ...
  const hasSocialConnected =
    ...
    (settings.isLinkedInConnected && globalPlatforms.linkedin !== false && (statusFilter === 'All statuses' || statusFilter === 'Connected') && (platformFilter === 'All platforms' || platformFilter === 'LinkedIn')) ||
    (settings.isTwitterConnected && globalPlatforms.twitter !== false && (statusFilter === 'All statuses' || statusFilter === 'Connected') && (platformFilter === 'All platforms' || platformFilter === 'Twitter/X')) ||
    (settings.isPinterestConnected && globalPlatforms.pinterest !== false && (statusFilter === 'All statuses' || statusFilter === 'Connected') && (platformFilter === 'All platforms' || platformFilter === 'Pinterest')) ||
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
              ...
              <div>
                <h3 style={{ fontSize: '1.25rem', fontWeight: '800', color: 'var(--text-main)', margin: 0 }}>Connect Telegram Bot</h3>
                <span style={{ fontSize: '0.8rem', color: 'var(--text-muted)', fontWeight: '500' }}>Community & Bot Engagement</span>
              </div>
            </div>
            ...
            <div style={{ marginBottom: '24px' }}>
              <label style={{ display: 'block', fontSize: '0.78rem', fontWeight: '800', color: 'var(--text-muted)', textTransform: 'uppercase', marginBottom: '8px', letterSpacing: '0.5px' }}>
                Telegram Bot Token
              </label>
              <input
                type="text"
          ...
          <div style={{
            ...
            <div style={{ padding: '24px', background: 'var(--bg-card)', borderBottom: '1px solid var(--border-subtle)' }}>
              <button
                ...
                onMouseOut={(e) => { e.currentTarget.style.color = 'var(--text-muted)'; e.currentTarget.style.background = 'var(--bg-dark)'; }}
              >
                <X size={18} />
              </button>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
                ...
                <h2 style={{ fontSize: '1.4rem', fontWeight: '800', color: 'var(--text-main)', margin: 0 }}>{selectedSettingsPlatform.name} settings</h2>
              </div>
              <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', margin: 0, paddingLeft: '52px' }}>Manage your {selectedSettingsPlatform.name} account connection and messaging preferences.</p>
            </div>
            ...
            <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
                      ...
                      {settings.linkedinPages.map(page => (
                        <div key={page.urn} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 14px', background: 'var(--sidebar-bg)', borderRadius: '8px', border: '1px solid var(--border-subtle)' }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                              <span style={{ fontSize: '0.85rem', fontWeight: '600', color: 'var(--text-main)' }}>{page.name}</span>
                              <span style={{ fontSize: '0.65rem', color: 'var(--text-muted)', wordBreak: 'break-all' }}>{page.urn}</span>
                            </div>
                          </div>
              ...
              <div style={{ background: '#fff1f2', borderRadius: '12px', padding: '20px', border: '1px solid #fecdd3', display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
                ...
                <button
                  ...
                  onMouseOut={(e) => { e.currentTarget.style.background = 'var(--bg-card)', e.currentTarget.style.borderColor = '#fecaca'; }}
                >
