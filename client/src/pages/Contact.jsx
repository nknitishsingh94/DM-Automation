...
export default function Contact() {
  ...
  if (submitted) {
    return (
      <div className="contact-page-container" style={{ textAlign: 'center', padding: '100px 20px' }}>
        <div style={{ maxWidth: '500px', margin: '0 auto', background: 'white', padding: '40px', borderRadius: '24px', boxShadow: '0 20px 40px rgba(0,0,0,0.05)' }}>
          ...
          <h2 style={{ fontSize: '2rem', fontWeight: '900', color: '#1e293b', marginBottom: '16px' }}>Message Received!</h2>
  ...
  return (
    <div className="contact-page-container" style={{ minHeight: '100vh', background: '#f8fafc', padding: '80px 20px' }}>
      <div style={{ maxWidth: '900px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: '40px', alignItems: 'start' }}>
        
        {/* Info Column */}
        <div style={{ padding: '20px' }}>
          <h1 style={{ fontSize: '2.5rem', fontWeight: '900', color: '#1e293b', marginBottom: '16px', letterSpacing: '-1px' }}>Contact Support</h1>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
              <div style={{ width: '48px', height: '48px', background: 'white', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#7c3aed', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}>
                <Mail size={24} />
              </div>
              <div>
                <p style={{ margin: 0, fontSize: '0.9rem', color: '#94a3b8', fontWeight: '700' }}>EMAIL US</p>
                <p style={{ margin: 0, fontSize: '1rem', color: '#1e293b', fontWeight: '600' }}>smart10x.support@gmail.com</p>
              </div>
            </div>
            
            <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
              <div style={{ width: '48px', height: '48px', background: 'white', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#10b981', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}>
                <MessageSquare size={24} />
              </div>
              <div>
                <p style={{ margin: 0, fontSize: '0.9rem', color: '#94a3b8', fontWeight: '700' }}>INSTAGRAM DM</p>
                <p style={{ margin: 0, fontSize: '1rem', color: '#1e293b', fontWeight: '600' }}>@smart10Xchat</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Form Column */}
        <div style={{ background: 'white', padding: '40px', borderRadius: '32px', boxShadow: '0 20px 40px rgba(0,0,0,0.04)', border: '1px solid #f1f5f9' }}>
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
              <div>
                <label style={{ display: 'block', fontSize: '0.9rem', fontWeight: '700', color: '#1e293b', marginBottom: '8px' }}>Your Name</label>
                <input 
                  type="text" 
                  required
            ...
            <div>
              <label style={{ display: 'block', fontSize: '0.9rem', fontWeight: '700', color: '#1e293b', marginBottom: '8px' }}>Subject</label>
              <select 
                value={formData.subject}
                onChange={e => setFormData({...formData, subject: e.target.value})}
                style={{ width: '100%', padding: '14px', borderRadius: '12px', border: '1px solid #e2e8f0', outline: 'none', fontSize: '1rem', appearance: 'none', background: 'white' }}
              >
            ...
            <div>
              <label style={{ display: 'block', fontSize: '0.9rem', fontWeight: '700', color: '#1e293b', marginBottom: '8px' }}>Message</label>
              <textarea 
                required
