...
const cookieCategories = [
  ...
  },
  {
    ...
    examples: [
      ...
      { name: 'retargeting_id', purpose: 'Enables remarketing campaigns to reach users who have previously visited smart10X.', duration: '30 days' },
    ]
  },
  {
    id: 'thirdparty',
...
const faqs = [
  ...
  { q: 'Do you use cookies for advertising?', a: 'We may use targeting cookies to measure the effectiveness of our advertising campaigns and show relevant content. You can opt-out of advertising cookies without affecting your use of the core smart10X platform features.' },
  { q: 'Do third parties set cookies through smart10X?', a: 'Yes. Some of our pages display content from, or are linked to, third-party content providers such as Meta (Facebook/Instagram), Google, and payment processors. These third parties may set their own cookies to track your interaction with their embedded content.' },
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        ...
        <div style={{ background: 'white', borderRadius: '24px', border: '1px solid #e2e8f0', padding: '36px', marginBottom: '32px', boxShadow: '0 4px 20px rgba(0,0,0,0.03)' }}>
          ...
          <div style={{ marginTop: '20px', padding: '16px 20px', background: '#fffbeb', borderRadius: '14px', border: '1px solid #fde68a', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
            ...
            <p style={{ color: '#92400e', fontSize: '0.88rem', lineHeight: '1.6', margin: 0, fontWeight: '500' }}>
              <strong>Please note:</strong> Disabling essential cookies will prevent you from logging in to smart10X and using core platform features. Disabling optional cookies will only affect analytics, personalisation, and advertising features.
            </p>
          </div>
        </div>
        ...
        <div style={{ background: 'white', borderRadius: '28px', border: '1px solid #e2e8f0', padding: '48px', textAlign: 'center', boxShadow: '0 8px 24px rgba(0,0,0,0.04)' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '14px' }}>
            <a href="mailto:privacy@smart10x.com" style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', background: 'linear-gradient(135deg, #f59e0b, #d97706)', color: 'white', padding: '14px 28px', borderRadius: '14px', textDecoration: 'none', fontWeight: '700', fontSize: '0.95rem', boxShadow: '0 8px 20px rgba(217,119,6,0.25)' }}>
